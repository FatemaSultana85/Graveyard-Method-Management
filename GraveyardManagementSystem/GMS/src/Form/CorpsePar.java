...
class CorpsePar {
   ...
   private String corpseName,corpseGender,corpseFatherName,
   ...
   private int fee,OwnerId;
   private String ownerNid;
   public CorpsePar(int generalGraveId,String generalGraveSize,int generalCorpseId
           ,String corpseName,String corpseGender,String corpseFatherName,
           ...
           int fee,int OwnerId,String ownerNid) 
   {
